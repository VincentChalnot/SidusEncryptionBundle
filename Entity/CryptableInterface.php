...
/**
 * This interface identifies the entities that have to be encrypted during doctrine's Flush event and be decrypted at postLoad
 * You need to return a array of the properties that needs to be encrypted and decrypted
 * 
